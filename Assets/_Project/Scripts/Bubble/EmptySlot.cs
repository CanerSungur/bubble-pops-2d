...
namespace BubblePops
{
    public class EmptySlot : MonoBehaviour
    {
        ...
        {
            if (_enableSequence != null && _enableSequence.IsPlaying())
                DeleteEnableSequence();

            transform.localPosition = new Vector2(50, -50);// messes up surround checks, make sure it got out of the way on disable
